 ...
 *
 */
public class Java_P_CS_Entertainment_Sync_10000 {
	...
	//consumer
		...
		private static Object lock = new Object();
		 ...
		 public Java_P_CS_Entertainment_Sync_10000()
		 {
			 try {
				Inital();
			} catch (Exception e) {
...
//						 System.out.println("Ava is :"+ava+" s");
	 ...
	 public static void main(String[] args) {
			 Java_P_CS_Entertainment_Sync_10000 p = new Java_P_CS_Entertainment_Sync_10000();
