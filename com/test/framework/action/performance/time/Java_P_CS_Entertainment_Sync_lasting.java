 ...
 *
 */
public class Java_P_CS_Entertainment_Sync_lasting {
	...
	//consumer
		...
		private static Object lock = new Object();
		 ...
		 public Java_P_CS_Entertainment_Sync_lasting()
		 {
			 try {
				Inital();
			} catch (Exception e) {
		 ...
		 float out = 0;
					...
					try {
						while(true)
						{
							...
							System.out.println("Count: ["+thread_count+"] Max:"+max+" Min:"+min+" Ava: "+ava);
						}
...
//	 
	 ...
	 public static void main(String[] args) {
			 Java_P_CS_Entertainment_Sync_lasting p = new Java_P_CS_Entertainment_Sync_lasting();
