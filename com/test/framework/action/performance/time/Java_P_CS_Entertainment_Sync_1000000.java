 ...
 *
 */
public class Java_P_CS_Entertainment_Sync_1000000 {
	...
	//consumer
		...
		private static Object lock = new Object();
		 ...
		 public Java_P_CS_Entertainment_Sync_1000000()
		 {
			 try {
				Inital();
			} catch (Exception e) {
...
//	 
	 ...
	 public static void main(String[] args) {
			 Java_P_CS_Entertainment_Sync_1000000 p = new Java_P_CS_Entertainment_Sync_1000000();
