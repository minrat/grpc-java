 ...
 *
 */
public class Java_P_CS_Entertainment_Sync_100channel_1000 {
	...
	//consumer
		...
		private static Object lock = new Object();
		 ...
		 public Java_P_CS_Entertainment_Sync_100channel_1000()
		 {
			 try {
				Inital();
			} catch (Exception e) {
...
//							 System.out.println("Ava is :"+ava+" s");
	 ...
	 public static void main(String[] args) {
		 for (int i=0;i<100;i++)
		 {
			 Java_P_CS_Entertainment_Sync_100channel_1000 p = new Java_P_CS_Entertainment_Sync_100channel_1000();
